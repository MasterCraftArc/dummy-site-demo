...
{#if innerWidth && innerWidth < 1200}
	<section class="mobile-section">
		<div class="text-container-mobile">
			...
			<InternalButton link="/CaseStudies" text="Learn More" />
		</div>
...
{:else}
	<section class="section">
		<div class="h1-Container">
			...
			<h1 class="fade-in-fwd">Trusted by The Most <span>Critical </span>Systems in The World</h1>
		</div>
		<p class="fade-in-fwd">
			Most IT companies use the same set of tools and technology. Why settle for an IT provider
		...
		<img src={badges} alt="badges" loading="lazy" class="badges fade-in-fwd" />
	</section>
{/if}
